...
export default function BottomNav({ active, onChange }: Props) {
  return (
    <nav style={{
      ...
      width: '100%', maxWidth: 480, background: 'rgba(10,10,12,0.85)',
      borderTop: '1px solid rgba(255,255,255,0.06)', zIndex: 100,
      ...
      {/* Safe-area spacer (home indicator) with matching background */}
