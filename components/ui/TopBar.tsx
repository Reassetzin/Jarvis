...
export default function TopBar() {
  const [whoop] = usePersistentStore('whoop', { recovery: 0, sleep: 0, strain: 0, hrv: 0, rhr: 0 })
...
function StatBadge({ label, value, color }: { label: string; value: string; color: string }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: '#111', border: '1px solid #222', borderRadius: 4, padding: '3px 9px', minWidth: 40 }}>
